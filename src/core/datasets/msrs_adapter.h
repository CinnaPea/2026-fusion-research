...
#ifndef VISUAL_THERMAL_CONCEPT_MSRS_ADAPTER_H
#define VISUAL_THERMAL_CONCEPT_MSRS_ADAPTER_H
...
namespace qart::core::datasets {
    ...
    class MSRSAdapter final : public DatasetAdapter
    {
    public:
        [[nodiscard]]
...
#endif //VISUAL_THERMAL_CONCEPT_MSRS_ADAPTER_H