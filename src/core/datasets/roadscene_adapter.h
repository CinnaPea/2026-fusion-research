...
#ifndef VISUAL_THERMAL_CONCEPT_ROADSCENE_ADAPTER_H
#define VISUAL_THERMAL_CONCEPT_ROADSCENE_ADAPTER_H
...
namespace qart::core::datasets {
    ...
    class RoadSceneAdapter final : public DatasetAdapter
    {
    public:
        [[nodiscard]]
    ...
    private:
        ...
        [[nodiscard]]
        static std::filesystem::path modalityDirectory(
            const std::filesystem::path& datasetRoot,
        ...
        static void validateSourceStem(
...
#endif //VISUAL_THERMAL_CONCEPT_ROADSCENE_ADAPTER_H