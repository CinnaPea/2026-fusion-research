...
#ifndef VISUAL_THERMAL_CONCEPT_BATCH_VALIDATION_RESULT_H
#define VISUAL_THERMAL_CONCEPT_BATCH_VALIDATION_RESULT_H
...
#endif //VISUAL_THERMAL_CONCEPT_BATCH_VALIDATION_RESULT_H